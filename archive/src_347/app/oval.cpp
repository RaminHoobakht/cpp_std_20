...
namespace ramin {
    ...
    void oval::draw() const noexcept(true) {
        std::cout << "oval::draw() vas called. drawing: " << m_description_
                  << " with x radius: " << m_x_radius_
                  << " and y radius: " << m_y_radius_ << nl;
    }

    void oval::draw(const int color_dept) const noexcept(true) {
        std::cout << "oval::draw() was called. color depth is: " << color_dept
                  << nl;
    }
