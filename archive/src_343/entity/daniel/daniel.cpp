...
namespace inh {
    ...
    daniel::daniel(const unsigned int e_param, const unsigned int f_param) noexcept(true) :
        daniel{zero, zero, zero, zero, e_param, f_param} {}

    daniel::daniel(const unsigned int c_param, const unsigned int d_param,
                   const unsigned int e_param, const unsigned int f_param) noexcept(true) :
        daniel{zero, zero, c_param, d_param, e_param, f_param} {}

    daniel::daniel(const unsigned int a_param, const unsigned int b_param,
                   const unsigned int c_param, const unsigned int d_param,
                   const unsigned int e_param, const unsigned int f_param) noexcept(true) :
    ...
    /* setter */
    void daniel::set_e(const unsigned int e_param) noexcept(true) { m_e_ = e_param; }

    void daniel::set_f(const unsigned int f_param) noexcept(true) { m_f_ = f_param; }
